...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        print(f"Debleeding was completed in {time.time() - start_time} seconds. Starting denoising now, which typically takes singificantly longer, especially if not using a GPU")
